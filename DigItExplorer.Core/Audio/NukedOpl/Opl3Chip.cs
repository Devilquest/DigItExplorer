...
/// <summary>The Nuked-OPL3 emulator's chip state: a straight port whose field names mirror the
/// original C source for line-by-line auditability; never consumed outside <c>DigItExplorer.Core.Audio</c>.</summary>
internal sealed class Opl3Chip
{
    internal const int OPL_WRITEBUF_SIZE = 1024;
