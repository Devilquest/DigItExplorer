...
/// <summary>The Nuked-OPL3 emulator's per-operator-slot state: a straight port whose field names mirror
/// the original C source for line-by-line auditability; never consumed outside <c>DigItExplorer.Core.Audio</c>.</summary>
internal sealed class Opl3Slot(Opl3Chip chip)
{
    internal delegate int ModFunc(Opl3Channel c);
    internal delegate int TremFunc(Opl3Slot s);
